    ...
    <form className="form-page" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex notes bg-main-light rounded-md p-3 my-2">
        <div className="notes-text w-1/2 p-2">
          <p>
            Các trang dạng tour list sẽ thiết kế theo chuẩn có tên, hình đại
            diện và danh sách list các tour category
          </p>
          <p>
            <span>Link: </span>
            <a
              className="text-main"
              href="https://imagevietnam.com/tour-nuoc-ngoai/"
            >
              Tour Nước Ngoài
            </a>
          </p>
        ...
        <div className="notes-image w-1/2 p-2">
          <img className="" src="/img/page-show-tour-list.jpg" alt="" />
        </div>
      </div>
      <input
        type="text"
