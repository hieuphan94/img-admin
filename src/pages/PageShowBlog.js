...
export const PageShowBlog = (props) => {
    ...
    <form className="form-page" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex notes bg-main-light rounded-md p-3 my-2">
        <div className="notes-text w-1/2 p-2">
          <p>
            Các trang blog sẽ thiết kế theo chuẩn chỉ có nội dung chữ và hình
            đại diện, xem hình hoặc link ví dụ bên dưới
          </p>
          <p>
            <span>Link: </span>
            <a
              className="text-main"
              href="https://imagevietnam.com/tour-du-lich-khach-doan/"
            >
              Tour Du lịch khách đoàn
            </a>
          </p>
        </div>
        <div className="notes-image w-1/2 p-2">
          <img className="" src="/img/page-show-blog.jpg" alt="" />
        </div>
      </div>
      <input
        type="text"
